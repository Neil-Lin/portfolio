<template>
  <Html :lang="htmlAttrs.lang" :dir="htmlAttrs.dir">
    ...
    <Link
      ...
      data-res="32x32"
      href="/portfolio/favicon-32.ico"
    />
    <Link
      rel="apple-touch-icon-precomposed"
      data-res="128x128"
      href="/portfolio/favicon-128.ico"
    />
    <Link
      rel="apple-touch-icon-precomposed"
      data-res="152x152"
      href="/portfolio/favicon-152.ico"
    />
    <Link
      rel="apple-touch-icon-precomposed"
      data-res="167x167"
      href="/portfolio/favicon-167.ico"
    />
    <Link
      rel="apple-touch-icon-precomposed"
      data-res="180x180"
      href="/portfolio/favicon-180.ico"
    />
    <Link
      rel="apple-touch-icon-precomposed"
      data-res="192x192"
      href="/portfolio/favicon-192.ico"
    />
    <Link
      rel="apple-touch-icon-precomposed"
      data-res="196x196"
      href="/portfolio/favicon-196.ico"
    />
    ...
    <Body class="wrapper">
      <div class="layout">
        ...
        <a
          id="ak-jump"
          href="#ak-container"
          :title="$t('shortcut.skipToContent')"
          >{{ $t("shortcut.skipToContent") }}</a
        >
        <slot />
      </div>
      <button
