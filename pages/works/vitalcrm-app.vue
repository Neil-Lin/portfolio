  ...
  <div>
    ...
    <article>
      ...
      <section>
        <h3>概要</h3>
        <p>
          Vital CRM 是一款專為中小企業量身打造的雲端顧客關係管理系統。2014 年推出新版
      ...
      <section>
        ...
        <div class="flex-list">
          <div>
            ...
            <ol>
              ...
              <li>痛點：舊版無任務管理系統、無法掌握員工位置、沒有佈告欄的系統。</li>
              <li>目標：立即取得資訊、知道下屬位置、指派任務、傳達重要資訊。</li>
            </ol>
          </div>
          <div>
            ...
            <ol>
              ...
              <li>目標：輕易的找到客戶、記錄與安排會議/約會、不管在哪都可以使用。</li>
            </ol>
          </div>
        </div>
        <div class="flex-list">
        ...
        <div class="flex-list">
          <div>
            ...
            <ol>
              <li>既要符合現有產品的視覺規範與個性，且還要盡量遵循 iOS 與 Android Guideline。</li>
              <li>
