...
const _ac7b74 = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '', handler: _ab2c5e, lazy: true, method: undefined },
  { route: '/__nuxt_error', handler: _ac7b74, lazy: true, method: undefined },
  { route: '/**', handler: _ac7b74, lazy: true, method: undefined }
];
