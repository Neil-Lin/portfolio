...
const components = {};
function componentsPlugin_e6fd71d0(nuxtApp) {
...
const vueuseHead_125fe6e3 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_5d0dc4d7 = defineNuxtPlugin((nuxtApp) => {
...
const routes = [
  {
    name: "index",
    path: "/",
    file: "/Users/neil/Documents/Code/portfolio/pages/index.vue",
    children: [],
    meta: meta$1,
  ...
  },
  {
    name: "vitalcrm",
    path: "/vitalcrm",
    file: "/Users/neil/Documents/Code/portfolio/pages/vitalcrm/index.vue",
    children: [],
    meta,
    component: () => Promise.resolve().then(function() {
      return index$1;
...
const router_0b14174d = defineNuxtPlugin((nuxtApp) => {
...
const Error404 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-7371678c"]]);
const _sfc_main$8 = {
  __ssrInlineRender: true,
  props: {
    appName: {
...
const Error500 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-5d1604e8"]]);
const _sfc_main$6 = {
  __ssrInlineRender: true,
  props: {
    error: Object
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><h2>Index</h2></div>`);
    };
  }
};
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "page page--detail" }, _attrs))}><h2>Vital CRM</h2></div>`);
}
const _sfc_setup$2 = _sfc_main$2.setup;
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/vitalcrm/index.vue");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<aside${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "list" }, _attrs))}>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, { to: "/" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h1 class="visually-hidden"${_scopeId}>Neil&#39;s portfolio</h1>`);
      } else {
        return [
          vue_cjs_prod.createVNode("h1", { class: "visually-hidden" }, "Neil's portfolio")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, { to: "vitalcrm" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`to vitalcrm`);
      } else {
        return [
          vue_cjs_prod.createTextVNode("to vitalcrm")
        ];
      }
    }),
    _: 1
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_List = __nuxt_component_0;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "wrapper" }, _attrs))}>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_List, null, null, _parent));
