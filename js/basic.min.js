 ...
 * portfolio, v1.0.0
 * Neil's portfolio
 * http://neil-lin.github.io/portfolio/
 *
 * By Neil Lin
 *
 * License: 
...
function scrollBarGotoButtom(){var t=document.querySelector(".container-box");t.scrollTop=t.scrollHeight-t.clientHeight}function showMain(){$(".container")&&($(".container").hasClass("container--split")||$(".container").addClass("container--split"))}function hideMain(){$(".container")&&$(".container").hasClass("container--split")&&$(".container").removeClass("container--split")}function autoTextareaHeight(){var t=document.getElementsByClassName("reply-text")[0],e=window.opera?t.offsetHeight+parseInt(window.getComputedStyle(t,null).getPropertyValue("border-top-width")):t.offsetHeight-t.clientHeight,n=function(t){t.style.height="auto",t.style.height=t.scrollHeight+e+"px"};t.addEventListener&&t.addEventListener("input",function(e){n(t)}),t.attachEvent&&t.attachEvent("onkeyup",function(){n(t)})}function checkTeatareaHeight(){var t=document.getElementsByClassName("reply-text")[0];t.value||(t.style.height="56px")}function replyResponse(){var t=document.getElementsByClassName("reply-text")[0];postGuestReply(t.value),scrollBarGotoButtom(),setTimeout(function(){t.value="",checkTeatareaHeight()},1e3),setTimeout(function(){postHostReply("感謝您的留言，謝謝！")},2e3),setTimeout(function(){showMenu()},3500)}function postGuestReply(t){$(".conversation-list").append("<div class='conversation-item conversation-item--guest'><div class='avatar fal fa-user'></div><div class='content'><div class='msg-list'><div class='msg-item content-text'>"+t+"</div></div></div></div>")}function postHostReply(t){$(".conversation-list").append("<div class='conversation-item conversation-item--host'><div class='avatar'></div><div class='content'><div class='msg-list'><div class='msg-item content-text'>"+t+"</div></div></div></div>"),scrollBarGotoButtom()}function showMainPage(t){showMain(),setTimeout(function(){$.ajax({url:t,success:function(e,n,o){$(".main .content").load(t,function(){$("img.project-img").on("load",function(){$(".project-box").addClass("is-show")});var t=new Image;t.onload=function(){$(".project-box").addClass("is-show")}}),$(".container-right").scrollTop=0},error:function(t,e,n){alert("error!")},complete:function(t,e){$(".loading").fadeOut()}})},300)}function getIdtoShow(t){var e=$(t).attr("id");showMainPage(e+".html")}function showMenu(){html="<div class='conversation-item conversation-item--host'><div class='avatar'></div><div class='content'><div class='msg-list'><div class='msg-item content-text'>還想看看哪些呢？</div><div class='msg-item content-menu'><a href='javascript:;' class='about content-menu-item'><span>關於我</span></a><a href='javascript:;' class='contact content-menu-item'><span>留言</span></a><a href='javascript:;' class='projects content-menu-item'><span>專案作品</span></a></div></div></div>",$(".conversation-list").append(html),scrollBarGotoButtom()}$(document).ready(function(){$(document).on("click",".about",function(){showMainPage("about.html")}),$(document).on("click",".contact",function(){$(".reply").addClass("is-show"),$(".reply-text").focus(),postHostReply("如果需要我回覆，您可以在留言裡寫上您的電子郵件 :)")}),$(document).on("click",".projects",function(){var t="",e="https://neil-lin.github.io/portfolio/json/projects.json";$.ajax({url:e,dataType:"json",success:function(e){for(i=0;i<e.length;i++)t+="<div class='msg-item content-card'><a href='javascript:;' onclick='getIdtoShow("+e[i].Id+");' class='card-image lazy' data-src='"+e[i].Image+"' style='background-image: url(\"images/loading.gif\");'></a><div class='card-content'><div class='card-text'><div class='card-title'>"+e[i].Title+"</div><div class='card-des'>"+e[i].Description+"</div><button class='btn card-btn' id='"+e[i].Id+"'> 觀看作品 </button></div></div></div>";t="<div class='conversation-item conversation-item--host'><div class='avatar'></div><div class='content'><div class='msg-list msg-list--card'>"+t+"</div><button class='btn back-to-menu'> 返回選單 </button></div></div>",$(".conversation-list").append(t),scrollBarGotoButtom(),$(".lazy").lazy({appendScroll:$(".msg-list--card")}),$(".card-btn").on("click",function(){getIdtoShow($(this))}),$(".back-to-menu").on("click",function(){showMenu()})},error:function(t,e,n){alert("發生錯誤了"),alert(t.responseText)}})}),$(document).on("focus",".reply-text",function(){autoTextareaHeight()}),$(document).on("blur",".reply-text",function(){checkTeatareaHeight()}),$(document).on("click",".send-reply-btn",function(){$(".reply-text").val()&&(replyResponse(),$(".send-reply-btn").addClass("send-out"),setTimeout(function(){$(".send-reply-btn").removeClass("send-out")},1e3),$(".reply").removeClass("is-show"))}),$(document).on("click",".btn-close-content",function(){hideMain(),$(".container-right .main .content").empty()})});
